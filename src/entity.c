...
const EntityTemplate entity_table[] = {
    ...
    {"Ghost Girl", 208, ENTITY_VISIBLE | ENTITY_SOLID | ENTITY_INTERACTABLE | ENTITY_ANIMATE},
    {"Sword Man",  256, ENTITY_VISIBLE | ENTITY_SOLID | ENTITY_INTERACTABLE | ENTITY_ANIMATE},
    {"Bug Man",    384, ENTITY_VISIBLE | ENTITY_SOLID | ENTITY_INTERACTABLE | ENTITY_ANIMATE},
    {"Dream Worm", 560, ENTITY_VISIBLE | ENTITY_SOLID | ENTITY_INTERACTABLE | ENTITY_ANIMATE},
    {"Skuller",    192, ENTITY_VISIBLE | ENTITY_SOLID | ENTITY_INTERACTABLE | ENTITY_ANIMATE},
    {"Mook",       368, ENTITY_VISIBLE | ENTITY_SOLID | ENTITY_INTERACTABLE | ENTITY_ANIMATE},
    {"The Seer",   208, ENTITY_VISIBLE | ENTITY_SOLID | ENTITY_INTERACTABLE | ENTITY_ANIMATE},
